	<head>
		...
		<title><?php if(isset($title)) echo $title; else echo "Modèle Portfolio";?></title>
		<link href="https://fonts.googleapis.com/css?family=Carter+One|Sigmar+One&display=swap" rel="stylesheet">
	</head>
